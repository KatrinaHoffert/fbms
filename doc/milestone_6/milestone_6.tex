...
\subsection{Domain model}
 The diagram is too large so it is not included directly in the document but is available at images/domainDiagram.png
...
\begin{longtable}{| p{0.2cm} p{6.25cm} | p{3cm}| p{5cm} |}
  ...
  5. & Complete implementation &  & These conventions were followed mostly from the start. \\ \hline
...
\begin{longtable}{| p{2cm} | p{5cm} | p{3cm}| p{4.5cm} |}
  ...
  \multicolumn{2}{|r|}{\textbf{Total for Hoffert}} & 96 hours & 67\% of the commits from one person\\ \hline \hline
  ...
  \multicolumn{2}{|r|}{\textbf{Total for Butler}}  & 37 hours & \\ \hline \hline

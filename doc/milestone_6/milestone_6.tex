...
\subsubsection{Revert Revision$^{Rizvi}$} 
\begin{description}
	\item[•] \textbf{Level}  \hfill \\
	Summary
	...
	26 November 2013	
\end{description}
\subsubsection{View revision$^{Rizvi}$}
\begin{description}
	\item[•] \textbf{Level}  \hfill \\
	Summary
	\item[•] \textbf{Actor} \hfill \\
...
\begin{description}
	\item[•] \textbf{OS Compatibility} \hfill \\
...
\noindent{\textbf{\texttt{DbConnection.getFileRevisions(Path file)}}}
	\begin{description}
	\item[Cross references:] \hfill \vspace{-4ex}  \\
		\begin{description} 
		\item[Operation contracts:] \hfill \\
...
\noindent{\textbf{\texttt{DbConnection.setConfig(String settingName, String settingValue)}}}
\begin{description}
	\item[Cross references:] \hfill \vspace{-4ex}  \\
		\begin{description} 
		\item[Operation contracts:] \hfill \\
...
\todonote{Revised by Da. References to use cases are added. Anyone would like to check again about all those?}
...
\hspace{1em} The test file is in /trunk/main/src/cmpt370/fbms/test. TesterMainSuite.java is the test suite of the project.
\par

...
\todonote{Add linux images of the above cases here (try to get full windows that show off the program well)}
...
\todonote{Alsharif. Adapt from M4.}
...
\subsubsection{Delete file}
\noindent{\includegraphics[width=\linewidth]{images/DeleteFileSD.png}} \\
...
\begin{longtable}{| p{0.2cm} p{6.25cm} | p{3cm}| p{5cm} |}
  ...
  8. & Acknowledgements & Hoffert(0.25h) &  \\ \hline
   & References & Hoffert(0h) &  \\ \hline
    & \textbf{Total member contributions} & \textbf{Hoffert} & 8.85h \\ \cline{3-4}
    &  & \textbf{Tao} & 4.5h \\ \cline{3-4}
    &  & \textbf{Butler} & \\ \cline{3-4}
    &  & \textbf{Rizvi} & \\ \cline{3-4}
    &  & \textbf{Alsharif} & \\ \hline
    & \textbf{Grand total} &  & 13.35h \\ \hline
\end{longtable}

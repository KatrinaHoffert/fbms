...
\begin{longtable}{| p{0.2cm} p{6.25cm} | p{3cm}| p{5cm} |}
  ...
  6. & Project plan, evaluation & Hoffert(0.25h) &  \\ \hline
  7. & Conclusion &  &  \\ \hline
  8. & Acknowledgements &  &  \\ \hline
   & References &  &  \\ \hline
    & \textbf{Total member contributions} & \textbf{Hoffert} & 5.45h \\ \cline{3-4}
    &  & \textbf{Member2} & \\ \cline{3-4}
    &  & \textbf{Member3} & \\ \cline{3-4}
    &  & \textbf{Member4} & \\ \cline{3-4}
    &  & \textbf{Member5} & \\ \hline
    & \textbf{Grand total} &  & 5.45h \\ \hline
\end{longtable}
...
\begin{longtable}{| p{2cm} | p{5cm} | p{3cm}| p{4.5cm} |}
  ...
  \multicolumn{2}{|r|}{\textbf{Total for Hoffert}} & 93 hours & \\ \hline \hline
  Tao &  &  & \\ \cline{2-4}
   &  &  & \\ \cline{2-4}
   &  &  & \\ \cline{2-4}
   &  &  & \\ \hline

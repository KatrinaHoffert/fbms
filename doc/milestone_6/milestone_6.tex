...
\begin{longtable}{| p{2cm} | p{5cm} | p{3cm}| p{4.5cm} |}
  ...
  Alsharif & Milestone (1-3)  & 6 hours & \\ \cline{2-4}
   &  work on presentation slides & 3 hours & \\ \cline{2-4}
   &  FileOp.creatDiff &  4 hours & \\ \cline{2-4}
   &  FileOp.fileToList &  4 hours & \\ \cline{2-4}
   &  Test FileOp.creatDiff &  3 hours & \\ \cline{2-4}
   &  Test FileOp.fileToList &  6 hours & \\ \cline{2-4}
   &  FileOp.applyDiff &  6 hours & \\ \cline{2-4}
   
  \multicolumn{2}{|r|}{\textbf{Total for Alsharif}}  & 32 hours & \\ \hline
\end{longtable}

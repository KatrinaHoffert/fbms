...
\begin{description}
	...
	\item \textbf{Extensions} \\
		...
		\item Nothing will happen if the user selects the file and revision and exits the dialogue or otherwise does not hit â€˜Okâ€™.  
...
\begin{longtable}{| p{0.2cm} p{6.25cm} | p{3cm}| p{5cm} |}
  ...
  8. & Acknowledgements & Hoffert(0.25h) &  \\ \hline
   & References & Hoffert(0h) &  \\ \hline
    ...
    & \textbf{Grand total} &  & 20.85h \\ \hline
\end{longtable}

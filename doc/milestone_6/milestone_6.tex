...
\begin{longtable}{| p{0.2cm} p{6.25cm} | p{3cm}| p{5cm} |}
  ...
  8. & Acknowledgements & Hoffert(0.25h) &  \\ \hline
   & References & Hoffert(0h) &  \\ \hline
    ...
    & \textbf{Grand total} &  & 47.25h \\ \hline
\end{longtable}
...
\begin{longtable}{| p{2cm} | p{5cm} | p{3cm}| p{4.5cm} |}
  ...
  Rizvi & Milestone(1-3) documentation & 5 hours  & \\ \cline{2-4}
  ...
  \multicolumn{2}{|r|}{\textbf{Total for Rizvi}}  &  35 hours & \\ \hline \hline
